...
$count=sql_fetch_num_rows($run_dublicate);
    ...
    if($count>0) 
    {
     	...
     	$sql_crm_lead="INSERT INTO crm_leads VALUES(NULL,'$lead_name','$lead_email','$lead_mobile','$lead_city','call','$logged_user_id','Free trail','$logged_user','$current_data_time','$ip')"; 	
			...
			$demoend=sql_injection($_POST['end']);
			 ...
			 $crm_demousers="INSERT INTO crm_demousers VALUES (null,'$get_latest_lead_id','$requested_plan','$current_data_time','$demostart','$demoend','$logged_user_id','$user_comments')";
